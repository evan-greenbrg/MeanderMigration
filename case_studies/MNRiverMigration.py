...
path_1995 = '/Users/greenberg/Documents/PHD/Projects/Chapter2/Re_Analysis/MNRiver/1991/width_dfs/width_dfs_1991.pickle'

with open(path_1995, 'rb') as handle:
    dfs_1995 = pickle.load(handle)

path_2015 = '/Users/greenberg/Documents/PHD/Projects/Chapter2/Re_Analysis/MNRiver/2013/width_dfs/width_dfs_2013.pickle'
...
root = '/Users/greenberg/Documents/PHD/Projects/Chapter2/Re_Analysis/MNRiver/migration'
migration_dfs = {}
bar_dfs = {}
for key_1995, key_2015 in zip(keys_1995, keys_2015):
    i = int(key_1995.split('/')[-1].split('_')[-3])
    ...
    outpath = os.path.join(
        root,
        'points',
        'migration_{}_1991_2013.csv'.format(i)
    )
    ...
    outpath = os.path.join(
        root,
        'bar',
        'bar_migration_{}_1991_2013.csv'.format(i)
    )
...
root = '/Users/greenberg/Documents/PHD/Projects/Chapter2/Re_Analysis/MNRiver'
out_path = os.path.join(
    root,
    'MN_migration_1991_2013.csv'
)
migration_df = pandas.DataFrame()
for i, df in migration_dfs.items():
    df['i'] = i
    migration_df = pandas.concat([migration_df, df])
migration_df.to_csv(out_path)

out_path = os.path.join(
    root,
    'MN_bar_migration_1991_2013.csv'
)
bar_df = pandas.DataFrame()
for i, df in bar_dfs.items():
    df['i'] = i
    bar_df = pandas.concat([bar_df, df])
